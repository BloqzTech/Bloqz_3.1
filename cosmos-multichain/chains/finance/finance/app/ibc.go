...
func (app *App) registerIBCModules(appOpts servertypes.AppOptions) error {
	...
	app.IBCFeeKeeper = ibcfeekeeper.NewKeeper(
		app.appCodec,
		app.GetKey(ibcfeetypes.StoreKey),
	...
	var transferModule porttypes.IBCModule = ibctransfer.NewIBCModule(app.TransferKeeper)
	transferModule = ibcfee.NewIBCMiddleware(transferModule, app.IBCFeeKeeper)

	// integration point for custom authentication modules
	var noAuthzModule porttypes.IBCModule
	var icaControllerModule porttypes.IBCModule = icacontroller.NewIBCMiddleware(noAuthzModule, app.ICAControllerKeeper)
	icaControllerModule = ibcfee.NewIBCMiddleware(icaControllerModule, app.IBCFeeKeeper)

	var icaHostModule porttypes.IBCModule = icahost.NewIBCModule(app.ICAHostKeeper)
	icaHostModule = ibcfee.NewIBCMiddleware(icaHostModule, app.IBCFeeKeeper)
	...
	ibcRouter := porttypes.NewRouter().
		...
		AddRoute(icahosttypes.SubModuleName, icaHostModule)
